...
# Deep methodology (asymmetric bets, 1992 GBP short, BOJ regime detection,
# stop-loss discipline, JP-specific signal thresholds, historical errors).
_DRUCK_METHODOLOGY = load_methodology("stanley_druckenmiller")
...
def generate_druckenmiller_output(
    ...
    methodology_block = (
                ...
                f"Study this carefully — apply its specific thresholds, historical "
                f"trades (1992 GBP, Tech bubble exit, BOJ regime), stop-loss discipline, "
                f"and Japan section to the facts below:\n\n"
                f"---\n{_DRUCK_METHODOLOGY}\n---\n"
                f"=== End of methodology ===\n"
            ) if _DRUCK_METHODOLOGY else ""
